import { customers, uiState } from "../state.js";
...
export function renderCustomer(data, onChange){
  ...
  svg.selectAll(".bar")
    ...
    .attr("y",h-m)
    .attr("height",0)
    .on("click",(e,d)=>{uiState.selectedCustomer=uiState.selectedCustomer===d.key?null:d.key;onChange();})
